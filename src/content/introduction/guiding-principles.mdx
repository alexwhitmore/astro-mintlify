...
If we can reasonably build, deploy, maintain it ourselves,
...
As a project generator, it is expected
...
Try to keep the amount of time it takes to get an
...
Avoid providing more than one way to do the same thing. This
applies to both the pre-configured code and the documentation.

### Offline Development

We want to enable offline development as much as

...
title: 'Examples'
date: '2024-06-28'
description: 'Explore community-contributed examples and extensions for the Epic Stack.'
draft: false
type: 'miscellaneous'
---
...
In keeping with the [guiding principle](guiding-principles.md) to "Minimize Setup Friction," this page links to examples of how to implement various features with the Epic Stack that aren't common enough to be included in the main template.

## Community Examples

Here's a list of community-contributed examples:
...
You don't need permission to contribute an example. Create your own repository based on the Epic Stack and add your desired features. Here are some tips:

1. Create an `init` commit immediately after generating the project.
2. Update the `README.md` with information about your example and interesting features.
3. Add the tags "epic-stack" and "epic-stack-example" to your repository.
4. Deployment to production is optional.

To add your example to this list, open a pull request to this page and add your example to the bottom of the list with a brief description.

For more details, watch: [Contribute an Epic Stack Example](https://www.epicweb.dev/tips/contribute-an-epic-stack-example)

These examples showcase the versatility and extensibility of the Epic Stack, providing developers with a wealth of resources for enhancing their projects.
